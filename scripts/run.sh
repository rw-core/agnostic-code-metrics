#!/usr/bin/env bash
#
# Fast path for the agnostic-code-metrics composite action.
#
...
# ACM_BASE_URL lets a GHES mirror (or tests) override the release host.
base_url="${ACM_BASE_URL:-https://github.com/${repo}/releases/download/${ref}}"
